  ...
  return (
    <main className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8 flex flex-col justify-between gap-5 xl:flex-row xl:items-end">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-brass">Barbeiros</p>
          <h1 className="mt-3 text-4xl font-semibold tracking-[-0.03em] sm:text-5xl">
            Equipe operacional.
          </h1>
          <p className="mt-3 max-w-2xl text-muted">
            Gerencie perfis publicos, status de agenda, especialidades e ordem de exibicao.
          </p>
        </div>
        <div className="grid grid-cols-2 overflow-hidden rounded-[1.25rem] border border-line bg-smoke">
          ...
          <div className="px-5 py-4">
            <p className="text-2xl font-semibold">{barbers.length}</p>
